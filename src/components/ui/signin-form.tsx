...
export default function SignUpForm() {
  ...
  return (
    <Form {...form}>
      <div className="flex flex-col gap-2 text-left mb-6 max-w-md m-auto w-full">
        <h1 className="text-3xl font-bold">Create Account</h1>
        <p className="text-muted-foreground text-sm">
          Join Venato today! Fill in your details to get started.
        </p>
      </div>
      <form
        onSubmit={form.handleSubmit(onSubmit)}
        className="w-full max-w-md m-auto space-y-4"
      >
        {/* Name */}
        <FormField
        ...
        <div className="grid gap-2 sm:grid-cols-3">
          <Button variant="outline" type="button" className="rounded-full h-11 border-slate-200 hover:bg-slate-50">
            ...
            >
              <path fill="#4285F4" d="M24 9.5c3.54 0 6.71 1.22 9.21 3.6l6.85-6.85C35.53 2.53 29.93 0 24 0 14.62 0 6.44 5.38 2.57 13.22l7.98 6.2C12.38 13.62 17.74 9.5 24 9.5z" />
              <path fill="#34A853" d="M46.1 24.5c0-1.62-.15-3.18-.43-4.68H24v9.01h12.45c-.54 2.94-2.18 5.44-4.65 7.12l7.41 5.73C43.3 37.07 46.1 31.23 46.1 24.5z" />
              <path fill="#FBBC05" d="M10.55 28.42c-.48-1.43-.75-2.95-.75-4.52s.27-3.09.75-4.52l-7.98-6.2C.92 16.17 0 20 0 23.9c0 3.9.92 7.73 2.57 11.12l7.98-6.2z" />
              <path fill="#EA4335" d="M24 47.8c6.48 0 11.9-2.13 15.87-5.8l-7.41-5.73c-2.07 1.39-4.73 2.2-8.46 2.2-6.26 0-11.62-4.12-13.45-9.72l-7.98 6.2C6.44 42.62 14.62 47.8 24 47.8z" />
            </svg>
            Google
          </Button>
        ...
        <div className="text-center text-sm pt-4">
          ...
          <a href="/auths/login" className="text-primary-venato font-semibold hover:underline underline-offset-4">
            Sign In
          </a>
        </div>
      </form>
