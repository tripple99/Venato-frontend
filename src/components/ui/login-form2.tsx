...
// const LoginIn = loginSchema.pick({
//   email: true,
//   password: true,
// })

// type Login = z.infer<typeof LoginIn>

// export default function LoginForm2() {

//   const form = useForm<Login>({
//     resolver: zodResolver(LoginIn),
//     defaultValues: {
//       email: "",
//       password: "",
...
//         {/* Submit */}
//         <Button type="submit" className="bg-primary-venato text-white w-full hover:bg-accent hover:text-black hover:border-1 border-accent-foreground" >
//           Sign Up
//         </Button>
