    ...
    <form className={cn("flex flex-col gap-6", className)} {...props}>
      ...
      <div className="grid gap-6">
        ...
        <div className="grid gap-3">
          ...
          <Input id="password" type="password" required className="p-2" />
        </div>
        <Button type="submit" className="w-full bg-primary-venato p-5 text-white">
          Login
        </Button>
...
>
  <path d="M22.675 0h-21.35C.596 0 0 
      ...
      <div className="text-center text-sm">
        ...
        <a href="/auths/login" className="underline underline-offset-4">
          Sign up
        </a>
      </div>
    </form>
